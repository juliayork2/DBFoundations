...
-- 2025-11-22,JYork,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_JYork')
	 Begin 
	  Alter Database [Assignment07DB_JYork] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_JYork;
	 End
	Create Database Assignment07DB_JYork;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_JYork;
...
Select
   ...
   ,InventoryCount
   ,[PreviousMonthCount] = 
		IIF(Month(InventoryDate) = 1, 0, Lag(InventoryCount) Over (Order by ProductName, Year(InventoryDate)))
From vProductInventories
Order by ProductName, Cast(InventoryDate as Date);
Go
*/
